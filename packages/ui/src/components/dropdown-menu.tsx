...
const DropdownMenuItemLink: RFC<DropdownMenuItemLinkProps> = ({
  icon,
  onClick,
  containerClassName,
  children,
  ...
  return (
    <div
      onClick={onClick}
      className={twMerge(
        'flex w-full items-center px-4 py-3 outline-none hover:bg-slate-100 cursor-pointer',
        containerClassName
      )}
    >
      <>
